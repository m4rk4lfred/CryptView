...
const rowDesign = [
   ...
   return(
   <>
   <div data-aos={"fade-right"} className="h-auto w-full font-poppins tracking-widest text-lg font-bold mt-75 md:mt-0  ">
      <div  className="grid grid-cols-1 md:grid-cols-2">
         <div className="w-auto h-auto  flex flex-col items-center justify-center px-7  md:pl-25 md:items-start">
            <h1 className="text-primary-dark text-xl font-black tracking-[0.25em] md:text-5xl dark:text-[#F5F5F5]">Multichain Integration</h1>
            <h2 className="font-bold text-sm mt-5 tracking-[0.070em] text-branding">Track Every Asset, Across Every Chain.</h2>
            <p  className="text-center mt-5 font-normal text-sm leading-8 md:leading-10 text-[#737373] px-9 md:text-start md:px-0 dark:text-[#D9D9D9]">Effortlessly track your wallet balances, NFT collections, and DeFi positions across 120+ blockchains in one centralized dashboard.</p>
         </div>
