   ...
   return(
    <>
      <div className="flex flex-col px-12 items-center font-poppins gap-8 font-bold tracking-widest min-h-screen w-full mt-35 ">
         <h1 className="text-xl text-primary-text md:text-3xl"><span className="text-branding">Your Portfolio,</span> Levelled Up.</h1>
         <p className="text-primary-text text-center text-sm leading-7 font-normal md:px-35 ">Most traders lose money because they lack a clear view of their data. Don't be one of them. Create your free CryptView account to access the tools used by the top 1% of the market.</p>
